...
export default function Services() {
  return (
    <div className="container mx-auto mt-24 mb-32 p-4">
      <h2 className="tracking-wider w-fit mx-auto">SERVICES</h2>
      <h2 className="mx-auto w-fit text-3xl font-bold mb-8">MY SERVICES</h2>
      <section className="mb-16">
        ...
        >
          <div className="bg-white absolute md:-right-16 bottom-0 max-w-sm md:h-[350px] shadow-lg p-4 flex flex-col justify-center">
            ...
            <p className="mb-4 font-bold md:text-4xl text-xl">
              Lorem, ipsum dolor.
            </p>
            <p>
